...
user_events_data = [
    {
        ...
        "positives": ["I’ve been a backend engineer", "I used Java and Python", "My experience includes"],
        "negatives": ["What do you mean by", "That wasn’t my question"],
    },
    {
    ...
    },
    {
        ...
        "negatives": ["Thanks, and I also want to ask", "Goodbye—also one more thing"],
    },
]
...
agent_events_data = [
    ...
    },
    {
        ...
        "positives": ["Great — thanks for sharing", "Got it, that makes sense"],
    ...
    },
    {
        ...
        "positives": ["Let’s do a coding exercise", "Design an API", "Whiteboard the architecture"],
    ...
    },
    {
        ...
        "positives": ["I’m seeing a system error", "The tool crashed", "I lost connection"],
    ...
    },
    {
        ...
        "negatives": ["Thanks—now one more question"],
    },
    {
        "id": "Off_Topic_Detection_Event",
...
print("📤 Please upload your chat CSV (columns: Timestamp, Speaker, Message_Text)")
